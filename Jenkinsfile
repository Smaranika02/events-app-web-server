...
//        e.g https://github.com/Smaranika02/events-app-web-server.git might become https://github.com/MyName/external.git
...
//      https://github.com/Smaranika02/events-app-web-server.git
//      smaranika02
//      web-server-image
//      cnd-events-cluster 
//      us-east-1  
//      user01
//      demo-ui - Kubernetes deployment name- This is found in the kubernetes deployment.yaml
//      demo-ui - Name of the container to be replaced - in the template/spec section of the deployment.yaml
...
pipeline {
   ...
   environment {
        ...
        imageName = 'smaranika02/web-server-image'
        dockerImage = ''
        }
    stages {
        stage('Run the tests') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/Smaranika02/events-app-web-server.git'
        ...
        stage('Building image') {
         ...
         stage('update k8s') {
            ...
            steps {
                echo 'Set the image'
                     sh "kubectl -n user01 set image deployment/demo-ui demo-ui=${env.imageName}:${env.BUILD_NUMBER} --kubeconfig=${WORKSPACE}/.kube/config"
            }
        }     
